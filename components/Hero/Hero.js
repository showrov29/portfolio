...
const Hero = () => {
	...
	return (
		<section
			...
			<div className="flex flex-col pt-40 md:pt-0 select-none z-10">
				<h5
				...
				<h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
					<span className={`relative ${styles.emphasize} seq`}>Showrov </span>
					<span className="seq">Islam</span>
				</h1>
				<p>
					<span
						ref={typedEl}
						className="seq text-3xl text-gray-light-3 font-mono leading-relaxed"></span>
				</p>
				<div className="">
					<Profiles />
				</div>
